                ...
                foreach (var traitProto in categoryTraits)
                {
...

                    {
                        ...
                        if (trait.MutuallyExclusiveTraits.Count > 0)
                        {
                            ...
                            if (names.Count > 0)
                                tooltipParts.Add(Loc.GetString("trait-blacklist") + $" {string.Join(", ", names)}"); // Exodus-Localization
                        }
                        ...
                        if (trait.SpeciesBlacklist.Count > 0)
                        {
                            ...
                            if (names.Count > 0)
                                tooltipParts.Add(Loc.GetString("race-trait-blacklist") + $" {string.Join(", ", names)}"); // Exodus-Localization
                        }
